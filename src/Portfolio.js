...
function Portfolio() {
    return (
        <div className='bg-sky-900'>
            ...
            <p className='item-body px-60 font-tr2n'>Below are some of my personal projects, each reflecting my passion for creativity<br />
            ...
            <div className='flex justify-between px-60 py-10'>
                <section className='item-body w-1/2 px-5'>
                    ...
                    <p className='py-10 font-tr2n'>This is a mobile application using React-Native to guide individuals who are just starting out at the gym!</p>
                </section>
                <section className='item-body w-1/2 px-5'>
                    ...
                    <p className='py-10 font-tr2n'>A Python program that lets the user use their voice to open a web browser. When a user say something like 'open Google' or 'open Youtube,' it listens, recognizes the command, and opens up the browser to the website they've asked for. It is still a work
                        in progress.
                    </p>
                </section>
            </div>
