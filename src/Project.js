    ...
    return (
        <div className='bg-black'>
            ...
            <div className='flex justify-between px-60 py-10'>
                ...
                <section className='item-body w-1/2 px-5'>
                    <h2 className='mb-4 text-2xl tracking-tight font-tr2n text-gray-900 text-sky-400/100'>Pacifica Project</h2>
                    <a href='https://github.com/jedi24garcia/Pacifica_Project' rel=''>
                        <img src={pacificImage} className="w-full aspect-video object-cover rounded-lg hover:scale-110 transform transition duration-500 border-4 border-cyan-400" alt='' />
                    </a>
                    <p className='py-10 font-medium text-sky-400/100'>Serves as a comprehensive educational and research tool that enables users to survey, comprehend, and understands the cultural heritage customs, and etiquette of Pacific Culture.</p>
                </section>
                <section className='item-body w-1/2 px-5'>
                    <h2 className='mb-4 text-2xl tracking-tight font-tr2n text-gray-900 text-sky-400/100'>School Database</h2>
